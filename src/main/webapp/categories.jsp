...
<div class="toast-notification fixed top-5 right-5 z-50 bg-white border-l-4 border-red-500 shadow-2xl rounded-lg p-4 flex items-start gap-3 max-w-sm">
    ...
    <div><h4 class="font-bold text-red-600 text-sm">Failed!</h4><p class="text-sm text-gray-600 mt-1"><%= errorMsg %></p></div>
...
<div class="toast-notification fixed top-5 right-5 z-50 bg-white border-l-4 border-green-500 shadow-2xl rounded-lg p-4 flex items-start gap-3 max-w-sm">
    ...
    <div><h4 class="font-bold text-green-600 text-sm">Success!</h4><p class="text-sm text-gray-600 mt-1"><%= successMsg %></p></div>
    <button onclick="this.parentElement.remove()" class="ml-auto text-gray-400"><i class="fa-solid fa-xmark"></i></button>
</div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500">Manage product category names</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 font-semibold text-center">Product Count</th>
                    <th scope="col" class="px-6 py-4 font-semibold text-center w-48">Actions</th>
                </tr>
                </thead>
                <tbody>
                <%
                ...
                <tr><td colspan="4" class="text-center py-8 text-gray-500">No categories available.</td></tr>
                <% } %>
                </tbody>
            </table>
        </div>
...
<dialog id="addCatModal" class="p-0 rounded-lg shadow-xl backdrop:bg-gray-900/50 w-full max-w-md">
    <div class="bg-white rounded-lg">
        ...
        <form action="category" method="post" class="p-4 space-y-4">
            ...
            <div>
                <label class="block mb-1 text-sm font-medium text-gray-900">Category Name</label>
            ...
            <div class="flex justify-end gap-2 pt-4">
                <button type="button" onclick="document.getElementById('addCatModal').close()" class="text-gray-700 bg-white border border-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 hover:bg-gray-100">Cancel</button>
...
<dialog id="editCatModal" class="p-0 rounded-lg shadow-xl backdrop:bg-gray-900/50 w-full max-w-md">
    <div class="bg-white rounded-lg">
        ...
        <form action="category" method="post" class="p-4 space-y-4">
            ...
            <div class="flex justify-end gap-2 pt-4">
                <button type="button" onclick="document.getElementById('editCatModal').close()" class="text-gray-700 bg-white border border-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 hover:bg-gray-100">Cancel</button>
